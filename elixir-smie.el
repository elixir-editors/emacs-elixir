      ...
      (smie-prec2->grammar
       (smie-bnf->prec2
        '((id)
          ...
          (statement (non-block-expr "fn" match-statement "end")
                     ...
                     ("defrecord" non-block-exprs "do" statements "end")
                     ("def" non-block-expr "do" statements "end"))
          (non-block-exprs (non-block-expr "OP" non-block-exprs)
                           (non-block-expr "COMMA" non-block-exprs))
